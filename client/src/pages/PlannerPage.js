          ...
          {currentStep === 1 && (
            <div className="space-y-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setPlannerData((prev) => ({ ...prev, destinations: [e.target.value] }))
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setPlannerData((prev) => ({ ...prev, startDate: e.target.value }))
                }
                className="w-full p-3 border rounded-lg"
              />
              ...
              <input
                ...
                onChange={(e) =>
                  setPlannerData((prev) => ({ ...prev, endDate: e.target.value }))
                }
                className="w-full p-3 border rounded-lg"
              />
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {travelerTypes.map((type) => (
                <button
                  key={type.id}
                  onClick={() =>
                    setPlannerData((prev) => ({ ...prev, travelerType: type.id }))
                  }
                  className={`p-4 border rounded-lg ${
                    plannerData.travelerType === type.id
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
              {preferencesList.map((pref) => (
                <button
                  ...
                  className={`p-4 border rounded-lg ${
                    plannerData.preferences.includes(pref.id)
                      ? "border-blue-600 bg-blue-50"
                      : "border-gray-200"
                  }`}
                >
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              ...
              <div className="flex gap-4 mt-4">
                <button
                  onClick={exportPDF}
                  className="px-4 py-2 bg-gray-800 text-white rounded-lg flex items-center gap-1"
                >
